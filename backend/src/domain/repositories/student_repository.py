...
# apply Interface Segregation Principle by combining Reader and Writer interfaces
from src.domain.repositories.student.student_reader import StudentReader
from src.domain.repositories.student.student_writer import StudentWriter

class IStudentRepository(StudentReader, StudentWriter):
    pass
