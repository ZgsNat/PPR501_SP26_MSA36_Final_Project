...
class StudentORM(Base, TimestampMixin, SoftDeleteMixin):
    ...
    student_id = Column(String, unique=False, index=True, nullable=False)
    full_name = Column(String, nullable=False)
    email = Column(String, nullable=True)
    phone = Column(String, nullable=True)
    home_town = Column(String, nullable=True)
    birth_date = Column(String, nullable=True) 
    math_score = Column(Float, default=None, nullable=True)
    literature_score = Column(Float, default=None, nullable=True)
    english_score = Column(Float, default=None, nullable=True)
